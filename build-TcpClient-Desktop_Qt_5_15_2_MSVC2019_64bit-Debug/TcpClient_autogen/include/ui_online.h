...
public:
    ...
    void setupUi(QWidget *Online)
    {
        ...
        addFreiend_pb = new QPushButton(Online);
        addFreiend_pb->setObjectName(QString::fromUtf8("addFreiend_pb"));
        QFont font1;
        font1.setPointSize(12);
        addFreiend_pb->setFont(font1);

        verticalLayout->addWidget(addFreiend_pb);
    ...
    void retranslateUi(QWidget *Online)
    {
        ...
        addFreiend_pb->setText(QCoreApplication::translate("Online", "\346\267\273\345\212\240\345\245\275\345\217\213", nullptr));
    } // retranslateUi
